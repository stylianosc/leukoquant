...
// Scratch directory for debug output files. Default: /scratch0.
// Set at runtime via -scratchDir argument in Seg_Analysis / Seg_BiASM.
extern std::string g_scratch_dir;
