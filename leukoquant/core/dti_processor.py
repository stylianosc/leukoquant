...
class DTIProcessor:
    ...
    def run_dti(self,
        ...
        wf_file = self.workflow_dir / "dti_workflow.smk"
        ...
        bind_parts = (
            ...
            + [f"{str(scratch_host.absolute())}:{scratch_dir_sing}"]
        )
        ...
        config_file = str(out_path.absolute()) + "/dti_config.yaml"
...
def apply_dti(subject_input: Optional[str] = None,
    ...
    """Run DTI fitting and return a summary dict.
    ...
    proc = DTIProcessor()
    try:
        job_id, results_dir = proc.run_dti(
        ...
        print("✅ DTI job submitted successfully")
