...
Used for probabilistic segmentation of thalamic nuclei, integrated into FreeSurfer.

- Iglesias JE, Insausti R, Lerma-Usabiaga G, Bocchetta M, Van Leemput K, Greve D, van der Kouwe A, Caballero-Gaudes C, Paz-Alonso P (2018). A probabilistic atlas of the human thalamic nuclei combining ex vivo MRI and histology. *NeuroImage* (in press). https://arxiv.org/abs/1806.08634
